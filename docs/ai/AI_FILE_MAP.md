...
This is the minimal documentation map intended for AI assistants.

Notes:

- Links are relative to `docs/ai/`.
- Keep this list to ~20 files max; it should point to the most authoritative + most referenced docs.
...
- If you add a new doc that becomes authoritative or frequently referenced, swap it into this list (do not grow this list indefinitely).
